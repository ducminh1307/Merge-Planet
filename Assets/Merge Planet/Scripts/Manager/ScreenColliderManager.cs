...
public class ScreenColliderManager : MonoBehaviour
{
    ...
    void CreateScreenColliders()
    {
        ...
        top.transform.position = new Vector3(bottomLeftScreenPoint.x, topRightScreenPoint.y, 0f);
        ...
        bottom.transform.position = new Vector3(bottomLeftScreenPoint.x, bottomLeftScreenPoint.y - collider.size.y, 0f);
        ...
        left.transform.position = new Vector3(bottomLeftScreenPoint.x - .1f, bottomLeftScreenPoint.y, 0f);
